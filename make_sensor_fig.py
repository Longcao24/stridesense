#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Diagram of a phone's 6-axis IMU: accelerometer (3-axis linear acceleration a) + gyroscope (3-axis angular velocity ω). Enlarged-font version. -> figs/imu_sensors.png"""
...
ax.text(9,2.4,"iPhone · 6 轴 IMU",ha="center",va="center",color=ACC,fontsize=13.5,fontweight="bold")
ax.text(20,12,"内含",ha="center",va="center",color=DIM,fontsize=13)
ax.add_patch(FancyArrowPatch((15,12),(25,12),arrowstyle="-|>",mutation_scale=18,lw=2.4,color=DIM))

# ---- Accelerometer: three-axis arrows ----
cx,cy,L=37,12,6.4
...
ax.text(cx,22.3,"加速度计 Accelerometer",ha="center",va="center",color=TXT,fontsize=15.5,fontweight="bold")
ax.text(cx,2.2,"采集:3 轴线性加速度 a (ax,ay,az)·含重力",ha="center",va="center",color=DIM,fontsize=13)

ax.text(57,12,"+",ha="center",va="center",color=DIM,fontsize=26,fontweight="bold")

# ---- Gyroscope: three-axis rotation ----
gx,gy=78,12
...
ax.text(gx,22.3,"陀螺仪 Gyroscope",ha="center",va="center",color=TXT,fontsize=15.5,fontweight="bold")
ax.text(gx,2.2,"采集:3 轴角速度 ω (ωx,ωy,ωz)",ha="center",va="center",color=DIM,fontsize=13)

# Right-side annotations
ax.text(107,15,"~60 Hz",ha="center",va="center",color=WARN,fontsize=15,fontweight="bold")
ax.text(107,10,"6 轴:a + ω",ha="center",va="center",color=DIM,fontsize=13)

plt.tight_layout(pad=0.2); plt.savefig("figs/imu_sensors.png",facecolor=BG,bbox_inches="tight"); plt.close()
print("saved figs/imu_sensors.png")
